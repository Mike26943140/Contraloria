<template>
  <button @click="toggleDarkMode" class="p-2 bg-transparent">
    <span v-html="isDarkMode ? darkModeIcon : lightModeIcon"></span>
  </button>
</template>
...
export default {
  data() {
    return {
      isDarkMode: false,
      darkModeIcon: `
        <svg class="fill-white" height="15" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 207.628 207.628" xml:space="preserve">
      ...
      `,
      lightModeIcon: `
        <svg class="fill-cmi" height="15" viewBox="-5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
          <title>moon</title>
          <desc>Created with Sketch Beta.</desc>
          <defs></defs>
          <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Icon-Set-Filled" transform="translate(-575.000000, -829.000000)" class="fill-cmi">
              <path d="M586.256,845 C586.256,838.1 590.735,832.236 597,829.991 C595.243,829.361 593.353,829 591.372,829 C582.33,829 575,836.164 575,845 C575,853.837 582.33,861 591.372,861 C593.353,861 595.243,860.639 597,860.009 C590.735,857.764 586.256,851.901 586.256,845" id="moon"></path>
            </g>
          </g>
        </svg>
      `
